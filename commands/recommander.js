...
async function recommander(interaction) {
    ...
    await DiscordCMD.sendRecommandation(interaction.client, config.SALONS.reco, interaction.user.id, iRecommended, interaction.options.getString('raison'), interaction.options.getBoolean('mission') ? "Mission" : "PCS/EXP/Autre", sGrade);
